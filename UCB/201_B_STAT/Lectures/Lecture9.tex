...
\begin{proof}
$$
\dfrac{\partial \ell}{\partial \theta} \Big|_{\theta^*} = 0
$$
\begin{tb}[CLT]
...
Let $\nabla g = \left( \frac{\partial}{\partial \theta_1} g(\theta), \ldots, \frac{\partial}{\partial \theta_k} g(\theta) \right)^\top$ be the gradient of $g$, and suppose that $\nabla g$ evaluated at $\hat{\theta}_n$ is not zero. Then
