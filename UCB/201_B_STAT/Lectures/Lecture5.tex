...
\label{subp:Benefits}
\begin{itemize}
  \item Increasing computational efficiency and decreasing storage requirements
  \item Involving irrelevant information may increase an estimator’s risk (see
Rao-Blackwell Theorem)
  \item Improving the scientific interpretability of our data
\end{itemize}% subparagraph Benefits (end)
\begin{eb}
