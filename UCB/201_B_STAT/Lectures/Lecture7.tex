...
$$
\mathcal{L}_n(\theta) = f_\theta (X_1,\dots,X_n;\theta) = \prod_{i=1}^n f_\theta (X_i;\theta) \text{\quad if the data are independent}
$$
...
$$\frac{\partial l_n(\theta)}{\partial \theta_j} = 0 \text{\quad for } j = 1,\dots,p$$
