...
\begin{db}[Sufficient Statistic]
    ...
    A statistic $T$ is \textbf{sufficient} for $\theta$ if , for every $t$ in the range of $\mathcal{T}$, the conditional distribution of $P_\theta(X| T(X) = t)$ is independent of $\theta$.
\end{db}
