...
\section[Lecture 6 (Sept 16) -- {\it TBD}]{Lecture 6}
...
\begin{proof}
    ...
    $$
    = \bigg[\frac{1}{(2\pi)^{n/2}} e^{\dfrac{\sum\limits_{i=1}^n x_i^2}{2}}\bigg] \cdot e^{-\dfrac{n\theta^2}{2} + \theta \sum\limits_{i=1}^n x_i} =  h(x) \cdot g_\theta(T(x))
    $$
...
f_{\mu,\sigma^2}(x_1,\dots,x_n) & = \prod_{i=1}^n f_{\mu,\sigma^2}(x_i) = \prod_{i=1}^n \frac{1}{\sqrt{2\pi}\sigma} e^{-\frac{(x_i - \mu)^2}{2\sigma^2}} = \frac{1}{(2\pi)^{n/2}\sigma^n} e^{-\frac{1}{2\sigma^2} \sum_{i=1}^n (x_i - \mu)^2} \\
 &  = \dfrac{1}{(2\pi)^{n/2}\sigma^n} \cdot \exp\{\frac{\mu}{\sigma^2} \sum\limits_{i=1}^n x_i - \dfrac{n\mu^2}{2\sigma^2} - \frac{1}{2\sigma^2} \sum\limits_{i=1}^n x_i^2\} \\
\end{align*}
\begin{align*}
